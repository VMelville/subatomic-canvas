...
namespace SubatomicCanvas.Model
{
    public class CanvasState
    {
        ...
        // public Vector3ReactiveProperty simulationWorldScale = new(new Vector3(1.73f, 1.73f, 1f)); // 直方体状 それぞれ、辺の長さで、単位は m
        public FloatReactiveProperty simulationWorldDepth = new(10f); // 単位は m
